// QVAC Fake Board Meeting Excuse Generator — core logic.
...
const FALLBACK = (v) => `Due to an unexpected scheduling conflict related to ${v}, I won't be able to join today's meeting, but I'll review the notes.`;
...
const KEYWORDS = ["unexpected", "apologize", "conflict", "follow up", "unavoidable", "circumstances", "reschedule"];
